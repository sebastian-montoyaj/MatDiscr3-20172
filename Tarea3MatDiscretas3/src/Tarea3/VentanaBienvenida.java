...
public class VentanaBienvenida extends JFrame implements Runnable
{
    ...
    public VentanaBienvenida()
    {
        ...
        Shape formaVentana = new RoundRectangle2D.Double(0, 0, this.getBounds().width, this.getBounds().height, 250, 250);
    ...
    private void initComponents() {
        ...
        jlTitulo.setText("<html>Tarea 3<br>Matemáticas Discretas III</html>");
